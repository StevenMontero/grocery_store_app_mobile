      ...
      builder: (context, state) {
        return TextFormField(
          ...
          decoration: InputDecoration(
              labelText:
                  AppLocalizations.of(context).tr('Nombre De Mi Mascota'),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.0),
              )),
          onChanged: (value) => context.bloc<PetCubit>().nameChanged(value),
          validator: (value) {
            if (value.length < 1) {
    ...
    return BlocBuilder<PetCubit, PetState>(
      ...
      builder: (context, state) {
        return TextFormField(
          initialValue: '',
          decoration: InputDecoration(
              labelText: AppLocalizations.of(context).tr('Raza De Mi Mascota'),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.0),
              )),
          onChanged: (value) => context.bloc<PetCubit>().breedChanged(value),
          validator: (value) {
            if (value.length < 1) {
  ...
  Widget _petAge() {
    return BlocBuilder<PetCubit, PetState>(
      ...
      builder: (context, state) {
        return TextField(
          decoration: InputDecoration(
              labelText: AppLocalizations.of(context).tr('Edad De Mi Mascota'),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.0),
              )),
          keyboardType: TextInputType.number,
          onChanged: (value) =>
              context.bloc<PetCubit>().ageChanged(int.parse(value)),
        );
      },
    );
  }
    ...
    return BlocBuilder<PetCubit, PetState>(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          decoration: InputDecoration(
              labelText:
                  AppLocalizations.of(context).tr('Pelaje De Mi Mascota'),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.0),
              )),
          onChanged: (value) => context.bloc<PetCubit>().furChanged(value),
          validator: (value) {
            if (value.length < 1) {
        ...
        BlocBuilder<PetCubit, PetState>(builder: (context, state) {
          return SwitchListTile(
            ...
            onChanged: (value) {
              setState(() {
                _isVacunas = value;
                context.bloc<PetCubit>().isVaccinationUpDateChanged(value);
              });
            },
          );
        }),
        BlocBuilder<PetCubit, PetState>(builder: (context, state) {
          return SwitchListTile(
            ...
            onChanged: (value) {
              setState(() {
                _isCastrated = value;
                context.bloc<PetCubit>().isCastratedDateChanged(value);
              });
            },
          );
        }),
        BlocBuilder<PetCubit, PetState>(builder: (context, state) {
          return SwitchListTile(
            ...
            onChanged: (value) {
              setState(() {
                _isSociable = value;
                context.bloc<PetCubit>().isSociableChanged(value);
              });
            },
          );
        })
    ...
    return BlocBuilder<PetCubit, PetState>(builder: (context, state) {
      return RaisedButton.icon(
        ...
        onPressed: () {
          ...
          context.bloc<PetCubit>().addPetForm(user.id);
